                ...
                <div className="flex justify-center gap-3">
                  {socialIcons.map((icon, index) => (
                    <a
                      ...
                      className="w-10 h-10 bg-orange-500 rounded-full shadow-md hover:bg-orange-600 hover:scale-110 transition-all duration-300 flex items-center justify-center text-white"
                    >
                      {icon.icon}
                    </a>
                  ))}
          ...
          <div className="flex justify-center gap-6 md:gap-8 mb-6">
            {socialIcons.map((icon, index) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-16 h-16 md:w-20 md:h-20 bg-orange-500 rounded-full shadow-lg hover:bg-orange-600 hover:scale-110 transition-all duration-300 flex items-center justify-center group text-white"
                aria-label={`Follow us on ${icon.name}`}
              >
                <div className="w-8 h-8 md:w-10 md:h-10 group-hover:animate-bounce">
                  {icon.icon}
                </div>
              </a>
            ))}
              ...
              <div className="flex gap-4">
                {socialIcons.map((icon, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full shadow-lg hover:bg-white/30 hover:scale-110 transition-all duration-300 flex items-center justify-center text-white group"
                    aria-label={`Follow us on ${icon.name}`}
                  >
                    <div className="w-6 h-6 group-hover:animate-pulse">
                      {icon.icon}
                    </div>
                  </a>
                ))}
